  ...
  return (
    <div className='max-w-lg flex flex-col gap-2 text-base'>
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-2 text-black'>
      ...
      {
        isEdit
        ? <input className='max-w-32 bg-gray-100' type="date" value={userData.dob} onChange={e => setUserData(prev => ({...prev,dob:e.target.value}))}/>
